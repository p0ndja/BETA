...
import me.palapon2545.music.api.tools.ActionBar;
				...
				if (args.length == 0) {
					if (pl.getConfig().getString("Players." + player.getName() + ".music").equalsIgnoreCase("false")) {
						player.sendMessage(ChatColor.WHITE + "You " + ChatColor.GREEN + ChatColor.BOLD + "UNMUTED "
								...
								+ "mute.");
						ActionBar music = new ActionBar(ChatColor.WHITE + "You " + ChatColor.GREEN + "UNMUTED "
								+ ChatColor.WHITE + "Music System." + ChatColor.YELLOW + " Type " + ChatColor.GOLD
						...
						if (pl.getConfig().getString("Players." + player.getName() + ".music")
							...
							player.sendMessage(ChatColor.WHITE + "You " + ChatColor.RED + ChatColor.BOLD + "MUTED "
									...
									+ "unmute");
							ActionBar music = new ActionBar(ChatColor.WHITE + "You " + ChatColor.RED + "MUTED "
									+ ChatColor.WHITE + "Music System." + ChatColor.YELLOW + " Type " + ChatColor.GOLD
					...
					if (args[0].equalsIgnoreCase("status")) {
						...
						if (player2.isOnline() && player2 != null) {
							if (args.length == 2) {
								...
								player.sendMessage(ChatColor.GREEN + "Type: " + ChatColor.BLUE + "/music status [Player]");
							}
						} else {
